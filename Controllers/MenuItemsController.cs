...
namespace TaacTapTerminalApp.Controllers
{
    public class MenuItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MenuItemId,Name,Price,Description,MenuId")] MenuItem menuItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MenuItemId,Name,Price,Description,MenuId")] MenuItem menuItem)
        {
            if (ModelState.IsValid)
            {
